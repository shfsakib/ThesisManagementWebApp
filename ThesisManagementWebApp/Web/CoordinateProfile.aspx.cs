...
{
    public partial class CoordinateProfile : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool ans = func.Execute($@"UPDATE Registration SET Name='{txtName.Text}',Email='{txtEmail.Text}',MobileNo='{txtMobile.Text}',Gender='{ddlGender.Text}',Picture='{pic}',Designation='{txtDesignation.Text}',IdNo='{txtTeacherId.Text}',Password='{txtPass.Text}' WHERE RegistrationId='{func.UserIdCookie()}'");
                if (ans)
                {

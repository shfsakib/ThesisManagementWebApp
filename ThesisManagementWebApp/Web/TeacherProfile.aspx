<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Dashboard.Master" AutoEventWireup="true" CodeBehind="TeacherProfile.aspx.cs" Inherits="ThesisManagementWebApp.Web.TeacherProfile" %>
        ...
        <div class="row">
            <div class="col-lg-12 p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        Preffer:
                        <asp:Label ID="lblPreffer" Style="font-size: 15px;" runat="server" Text="dob"></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        Free Schedule:
                        <asp:Label ID="lblSchedule" Style="font-size: 15px;" runat="server" Text="Schedule"></asp:Label>
                    </div>
                </div>
            </div>
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Dashboard.Master" AutoEventWireup="true" CodeBehind="ViewStudentReport.aspx.cs" Inherits="ThesisManagementWebApp.Web.ViewStudentReport" %>
        ...
        <div class="card card-body m-3">
            ...
            <div class="row pt-3">
                <div class="col-12  justify-content-center table-responsive">
                    <asp:GridView ID="gridStudent" Width="100%" class="table table-hover table-bordered table-striped" OnPageIndexChanging="gridStudent_OnPageIndexChanging" AutoGenerateColumns="False" ShowHeader="False" ShowHeaderWhenEmpty="True" EmptyDataText="No Report Found" AllowPaging="True" PageSize="30" runat="server">
                        <Columns>

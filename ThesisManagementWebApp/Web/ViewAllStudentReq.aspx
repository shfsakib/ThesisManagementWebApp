<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Dashboard.Master" AutoEventWireup="true" CodeBehind="ViewAllStudentReq.aspx.cs" Inherits="ThesisManagementWebApp.Web.ViewAllStudentReq" %>
                                ...
                                <ItemTemplate>
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <asp:Label ID="Label1" runat="server" Style="font-size: 25px; font-weight: bold;" Text='<%#Eval("Name")+" sent supervision request to "+Eval("TeacherName")+"("+Eval("TeacherEmail")+")"%>'></asp:Label>

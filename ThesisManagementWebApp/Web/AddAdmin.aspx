    ...
    <div class="card card-body m-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 justify-content-center">
                ...
                <asp:Image ID="imgPic" Style="border: 1px solid #d3d3d3; border-radius: 5px; margin-top: 5px; width: 175px; height: 175px;" ImageUrl="../DashboardFile/DummyPic.png" runat="server" />
            </div>
            <div class="col-lg-3"></div>
        </div>
        <div class="row">

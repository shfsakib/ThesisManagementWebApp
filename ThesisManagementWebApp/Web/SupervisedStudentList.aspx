<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Dashboard.Master" AutoEventWireup="true" CodeBehind="SupervisedStudentList.aspx.cs" Inherits="ThesisManagementWebApp.Web.SupervisedStudentList" %>
        ...
        <div class="card card-body m-3">
            <div class="row card-header mb-2 pl-2">
                <div class="col-sm-6 pl-0">
                    <h3 class="m-0">Accepted Student List</h3>
                </div>
            </div>
            <div class="row">
